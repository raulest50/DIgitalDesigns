...
HD_PWD='C:/RaulEsteban/DIgitalDesigns/Xilinx/Load_Sim/Load_Sim.runs/design_1_SineWave100s_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_SineWave100s_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_SineWave100s_0_0.tcl
