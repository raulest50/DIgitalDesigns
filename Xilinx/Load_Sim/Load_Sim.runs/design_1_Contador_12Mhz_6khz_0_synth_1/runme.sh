...
HD_PWD='C:/RaulEsteban/DIgitalDesigns/Xilinx/Load_Sim/Load_Sim.runs/design_1_Contador_12Mhz_6khz_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Contador_12Mhz_6khz_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Contador_12Mhz_6khz_0.tcl
