...
HD_PWD='C:/Users/erich/Documents/Digital_Designs/Xilinx/PruebaCargaRLC/PruebaCargaRLC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Full_wrapper.tcl -notrace
