...
HD_PWD='C:/Users/erich/Documents/Digital_Designs/Xilinx/PruebaCargaRLC/PruebaCargaRLC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Full_wrapper.tcl
