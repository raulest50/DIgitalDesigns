...
HD_PWD='C:/Users/erich/Documents/Digital_Designs/Xilinx/PruebaCargaRLC/PruebaCargaRLC.runs/Full_c_counter_binary_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_c_counter_binary_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Full_c_counter_binary_0_1.tcl
