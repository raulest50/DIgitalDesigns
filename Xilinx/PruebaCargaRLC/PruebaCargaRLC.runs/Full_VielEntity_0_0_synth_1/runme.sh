...
HD_PWD='C:/Users/erich/Documents/Digital_Designs/Xilinx/PruebaCargaRLC/PruebaCargaRLC.runs/Full_VielEntity_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_VielEntity_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Full_VielEntity_0_0.tcl
