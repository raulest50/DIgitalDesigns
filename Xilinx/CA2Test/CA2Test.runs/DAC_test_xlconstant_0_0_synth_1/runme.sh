...
HD_PWD='C:/Users/erich/Documents/Digital_Designs/Xilinx/DAC_test/DAC_test.runs/DAC_test_xlconstant_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DAC_test_xlconstant_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DAC_test_xlconstant_0_0.tcl
