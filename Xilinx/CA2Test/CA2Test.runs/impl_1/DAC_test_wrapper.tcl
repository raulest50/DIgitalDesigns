...
set rc [catch {
  ...
  catch { write_sysdef -hwdef DAC_test_wrapper.hwdef -bitfile DAC_test_wrapper.bit -meminfo DAC_test_wrapper.mmi -file DAC_test_wrapper.sysdef }
  catch {write_debug_probes -quiet -force DAC_test_wrapper}
  catch {file copy -force DAC_test_wrapper.ltx debug_nets.ltx}
