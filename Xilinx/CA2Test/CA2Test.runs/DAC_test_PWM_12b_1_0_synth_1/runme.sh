...
HD_PWD='C:/RaulEsteban/DIgitalDesigns/Xilinx/CA2Test/CA2Test.runs/DAC_test_PWM_12b_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DAC_test_PWM_12b_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DAC_test_PWM_12b_1_0.tcl
