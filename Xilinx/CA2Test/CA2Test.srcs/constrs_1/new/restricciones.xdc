...
set_property IOSTANDARD LVCMOS33 [get_ports Sine_recomp]
set_property IOSTANDARD LVCMOS33 [get_ports Sine]
set_property IOSTANDARD LVCMOS33 [get_ports PWM_Ca2]
...
set_output_delay -clock [get_clocks VIRTUAL_clk_out2_DAC_test_clk_wiz_0_0] -min -add_delay 0.000 [get_ports PWM_Ca2]
set_output_delay -clock [get_clocks VIRTUAL_clk_out2_DAC_test_clk_wiz_0_0] -max -add_delay 2.000 [get_ports PWM_Ca2]
set_output_delay -clock [get_clocks VIRTUAL_clk_out2_DAC_test_clk_wiz_0_0] -min -add_delay 0.000 [get_ports Sine]
set_output_delay -clock [get_clocks VIRTUAL_clk_out2_DAC_test_clk_wiz_0_0] -max -add_delay 2.000 [get_ports Sine]
set_output_delay -clock [get_clocks VIRTUAL_clk_out2_DAC_test_clk_wiz_0_0] -min -add_delay 0.000 [get_ports Sine_recomp]
set_output_delay -clock [get_clocks VIRTUAL_clk_out2_DAC_test_clk_wiz_0_0] -max -add_delay 2.000 [get_ports Sine_recomp]
