...
HD_PWD='C:/RaulEsteban/DIgitalDesigns/Xilinx/Load_Test/Load_Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Load_Test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Load_Test_wrapper.tcl
