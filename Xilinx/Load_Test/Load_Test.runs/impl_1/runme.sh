...
HD_PWD='C:/RaulEsteban/DIgitalDesigns/Xilinx/Load_Test/Load_Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Load_Test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Load_Test_wrapper.tcl -notrace
