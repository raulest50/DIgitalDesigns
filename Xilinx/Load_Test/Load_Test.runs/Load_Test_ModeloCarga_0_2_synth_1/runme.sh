...
HD_PWD='C:/Users/erich/Documents/Digital_Designs/Xilinx/Load_Test/Load_Test.runs/Load_Test_ModeloCarga_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Load_Test_ModeloCarga_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Load_Test_ModeloCarga_0_2.tcl
