...
HD_PWD='C:/RaulEsteban/DIgitalDesigns/Xilinx/Load_Test/Load_Test.runs/Load_Test_util_vector_logic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Load_Test_util_vector_logic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Load_Test_util_vector_logic_0_0.tcl
