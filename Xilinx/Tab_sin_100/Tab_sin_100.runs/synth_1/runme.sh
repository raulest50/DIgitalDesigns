...
HD_PWD='C:/Users/erich/Documents/Digital_Designs/Xilinx/Tab_sin_100/Tab_sin_100.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SineWave100s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SineWave100s.tcl
