...
HD_PWD='C:/RaulEsteban/DIgitalDesigns/Xilinx/FastPinPmodTest/FastPinPmodTest.runs/design_1_xlconstant_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xlconstant_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xlconstant_1_1.tcl
