...
HD_PWD='C:/RaulEsteban/DIgitalDesigns/Xilinx/FastPinPmodTest/FastPinPmodTest.runs/design_1_PWM_12b_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PWM_12b_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PWM_12b_1_0.tcl
