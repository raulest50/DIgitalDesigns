...
HD_PWD='C:/Users/erich/Documents/Digital_Designs/Xilinx/PModtestArty/PModtestArty.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodPWM_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PmodPWM_test.tcl -notrace
