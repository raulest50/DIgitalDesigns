...
set ipfs_ext "vho"
if {[file exists signal_gen.vho]} {
	set hdl_ext "vhd"
} else {
	puts "Warning: Could not find signal_gen.$ipfs_ext!"
}
...
# test bench settings
set_global_assignment -name EDA_DESIGN_INSTANCE_NAME signal_gen_inst -section_id tb
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.signal_gen_tb -section_id tb

# IPFS file
set_global_assignment -name EDA_IPFS_FILE "signal_gen.${ipfs_ext}" -section_id eda_simulation -library work
...
set_global_assignment -name EDA_TEST_BENCH_FILE "signal_gen_tb.${hdl_ext}" -section_id tb -library work
